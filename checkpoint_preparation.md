...
Ask an agent to review your code against the [Code Elegance Rubric](https://csc-343.path.app/rubrics/code-elegance.rubric.md). Request that the review include:
...
Ask an agent to review your module against the [Module Rubric](https://csc-343.path.app/projects/project-2-ai-system/ai-system.rubric.md). Request the review include:
